...
PROMPT='$(ssh_connection)%{$fg[white]%}%n ⪼ %{$fg[cyan]%}%~ ⪼ %{$reset_color%}'

# The right-hand prompt

RPROMPT='${time} %{$fg[magenta]%}$(git_prompt_info)$(git_prompt_short_sha)%{$reset_color%}$(git_prompt_status)%{$reset_color%}%{$reset_color%}'
